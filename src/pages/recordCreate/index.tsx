...
import {message, Tooltip, Button, Form, Space} from 'antd';
...
/*                <div style={{transform: 'translateX(+500%)'}}>
              ...
              <div style={{position: 'fixed', top: '90%', left: '50%', transform:'translate(-50%, -50%)'}}>
                <Button style={{}} type="primary" onClick={() => props.onSubmit?.()}>
                  下一步
                </Button>
              </div>
              );
...
{/*                  <Button key="goToTree">
            ...
            return (
              <div style={{position: 'relative', bottom: 0, left: '500%', transform:'translate(-50%, -50%)'}}>
                <Space>
                <Button type="primary" key="pre" onClick={() => props.onPre?.()}>
                  上一步
                </Button>
      ...
      >
        ...
        <StepsForm.StepForm<{
          ...
          onFinish={async () => {
            ...
            setModelName({modelName: modelInfo.data.modelName, modelId: modelInfo.data.id, modelUrl: modelInfo.data.dataUrl});
            return true;
          }}
        >
          {/*第二步 选择模型*/}
        ...
        >
          ...
          <div style={{width:'100%'}}>
            ...
            <EvaluationTable ref={evaluationRef} props={params} params={dataSetId} evaMethod={evaMethod} modelName={modelName} ></EvaluationTable>
          </div>
        </StepsForm.StepForm>
      </StepsForm>
    </ProCard>
